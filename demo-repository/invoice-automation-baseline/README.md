...
This is the clean, runnable target repository for the EnterpriseFlow and IBM
Bob demo. It models a small legacy invoice approval workflow while preserving
separate validation, processing, routing, and approval modules for Bob to
analyze and improve.
...
- `amount >= 500000` routes to **CFO**
- `amount < 500000` routes to **Finance Manager**
