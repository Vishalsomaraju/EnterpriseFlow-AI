...
export type BuildStatus = 'QUEUED' | 'ANALYZING' | 'PLANNING' | 'IMPLEMENTING' | 'TESTING' | 'WAITING_FOR_BOB' | 'CHANGES_RECEIVED' | 'VALIDATED' | 'READY_FOR_REVIEW' | 'ACTIVATED' | 'COMPLETED' | 'FAILED';
